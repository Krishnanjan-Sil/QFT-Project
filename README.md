...
1. **"Particles and Fields"** - Comprehensive review of Standard Model physics and cosmological connections
2. **"Higgs Physics"** - John Ellis (2013 Lectures) on the theoretical foundations, discovery, and future prospects
...
### I. Introduction: The Long Road from Quantum Mechanics to Cosmic Understanding
...
### II. Theoretical Foundations: The Mathematics of Fields
...
### III. Field Dynamics and Quantisation
...
### IV. Many-Body Physics and Computational Methods
...
### V. Applications in Particle Physics
- **Standard Model Architecture**: Three generations, anomaly cancellation, color confinement
- **Gauge Symmetries**: QED, QCD, Electroweak unification, $SU(2)_L \times U(1)_Y$
- **Higgs Mechanism**: Mexican hat potential, symmetry breaking, mass generation
...
### VI. Conclusion and Future Frontiers
...
3. Perturbation theory: Feynman rules, propagators, scattering amplitudes
